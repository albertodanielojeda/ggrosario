 ...
 */
@WebServlet(name = "VerDetallesJuegoServlet", urlPatterns = {"/admin/verDetallesJuego"})
public class VerDetallesJuegoServlet extends HttpServlet {
    ...
    public String getServletInfo() {
        return "Redirects to see Juegos details";
    }
