package com.herokuapp.ggrosario.servlet.rol;
 ...
 */
@WebServlet(name = "VerDetallesRolServlet", urlPatterns = {"/admin/verDetallesRol"})
public class VerDetallesRolServlet extends HttpServlet {
